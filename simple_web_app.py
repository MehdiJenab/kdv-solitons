...
def simulate():
    ...
    try:
        ...
        soliton_specs = [
            (float(s["kappa"]), float(s["x0"])) for s in (params.get("solitons") or [])
        ]
        ...
        times, solutions = solver.solve_with_history(t_final, n_snapshots=50, u0=u0)
        ...
        return jsonify(
            {
                ...
                "invariants": {
                    "mass": [iv[0] for iv in invariants],
